...
def compute_reward(action, time_slot):
    ...
    for _ in range(50):
        ...
        PN2 = cp.Variable(time_slot)
        uNt1 = Bandwidth * cp.log(1 + PN2[0] / (Loss[1][1] * I[1])) - c_f * PN2[0]
        uNt2 = Bandwidth * cp.log(1 + PN2[1] / (Loss[1][1] * I[4])) - c_f * PN2[1]
        ...
        uNt1 = Bandwidth * cp.log(1 + PN3[0] / (Loss[2][2] * I[2])) - c_f * PN3[0]
        uNt2 = Bandwidth * cp.log(1 + PN3[1] / (Loss[2][2] * I[5])) - c_f * PN3[1]
